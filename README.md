...
- Added shot script import/export workflow updates with `GLOBAL: ...` as the preferred format while keeping support for legacy multiline `GLOBAL:` blocks.
- Updated shot script import modal guidance and placeholder text to reflect the new preferred format and compatibility behavior.
